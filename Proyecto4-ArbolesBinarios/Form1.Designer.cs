namespace Proyecto4_ArbolesBinarios
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Ingrese la contraseña de acceso";
			// 
			// label3
			// 
			...
			// txtPass
			// 
			this.txtPass.Location = new System.Drawing.Point(221, 115);
			...
			this.label4.Text = "Sandra Milena Bolaños Delgado";
			// 
			// dateTimePicker1
			// 
			this.dateTimePicker1.Location = new System.Drawing.Point(147, 230);
